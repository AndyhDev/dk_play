...
public class SaveCurrentPlaylistDlg implements OnClickListener{
	...
	public SaveCurrentPlaylistDlg(Context context, SQLPlaylist playlist){
		this.context = context;
		this.playlist = playlist;
		
		dialog = new Dialog(context);
		dialog.setContentView(R.layout.new_playlist);
		dialog.setTitle("Die Aktuelle Playlist speichern");
