...
public class DynamicListView extends ListView {
    ...
    public SQLSongList mCheeseList;
    ...
    private Bitmap getBitmapWithBorder(View v) {
        ...
        can.drawBitmap(bitmap2, 0, 0, null);
        can.drawRect(rect, paint);
    ...
    private void swapElements(SQLSongList mCheeseList2, int indexOne, int indexTwo) {
    	Log.d("DY", "indexOne=" + indexOne);
        SQLSong temp = mCheeseList2.get(indexOne);
        mCheeseList2.set(indexOne, mCheeseList2.get(indexTwo));
        mCheeseList2.set(indexTwo, temp);
    }
        ...
        if (mCellIsMobile|| mIsWaitingForScrollFinish) {
            ...
            hoverViewAnimator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    invalidate();
                    if(dragListener != null){
                    	dragListener.onEnd(startPos, getPositionForID(itemId));
                    }
                }
            });
    ...
    public void setCheeseList(SQLSongList cheeseList) {
